...
// Asegurar que la columna 'reportada' exista
try {
...
// Procesar marcar como reportadas (para ambas secciones)
...
// Obtener últimas asistencias no reportadas
$stmt = $pdo->query("SELECT a.id, a.fecha_hora, c.nombre, c.apellido, u.nombre AS usuario, ac.nombre AS actividad
                    FROM asistencias a
...
// Obtener asistencias agrupadas por actividad
                ...
                <div class="card-body">
                    <form method="post" action="asistencia.php">
                        <div class="form-group">
                            <label for="busqueda">Buscar Cliente por Cédula:</label>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="post" action="asistencia.php">
                                            ...
                                            <div class="form-group">
                                                <label for="actividad_<?php echo $cliente['id']; ?>">Actividad:</label>
                                                <select id="actividad_<?php echo $cliente['id']; ?>" name="actividad_id" class="form-control" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <a href="historial_asistencia.php?id=<?php echo $cliente['id']; ?>" class="btn btn-info">
                                                    Ver Historial
                                                </a>
                                            </div>
                                        </form>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="asistencia.php" id="form-reportes-por-actividad">
                        ...
                        <?php else: ?>
                            <p>No hay asistencias registradas por actividad.</p>
                        <?php endif; ?>
                    </form>
                </div>
            </div>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="border: 1px solid #000; padding: 8px;"><?php echo $asistencia['nombre'] . ' ' . $asistencia['apellido']; ?></td>
                    <td style="border: 1px solid #000; padding: 8px;"><?php echo $asistencia['actividad']; ?></td>
                    <td style="border: 1px solid #000; padding: 8px;"><?php echo $asistencia['usuario']; ?></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
